    ...
    public static Integer[] randomValues(int lowerBound, int upperBound, int amount) {
        ...
        if (amount > upperBound - lowerBound) {
            ...
            for(int i = 0; i < amount; ++i) {
                int n;
                for(n = (int)(Math.random() * (double)(upperBound - lowerBound + 1) + (double)lowerBound); containsValue(values, n); n = (int)(Math.random() * (double)(upperBound - lowerBound + 1) + (double)lowerBound)) {
                }
